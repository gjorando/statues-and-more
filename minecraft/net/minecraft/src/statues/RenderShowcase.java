...
{
	private ModelShowcase showcase;
	protected TailleTileRender tailleTile;
	...
	{   
		...
		/*
		 * Calculate the lid orientation then render the showcase
		 */
		...
		/*
		 * Render the item in the showcase if necessary
		 */
	...
	/**
	 * Technical method used to render an item in the right hand of the showcase 
	 */
	public void renderItem(TileEntityShowcase tile, EntityLiving par1EntityLiving, ItemStack par2ItemStack, int par3)
    {
        GL11.glPushMatrix();
	...
	/**
	 * Technical method used by the method private void renderItem(TileEntityShowcase, EntityLiving, ItemStack, int) to render an item in 2D
	 */
